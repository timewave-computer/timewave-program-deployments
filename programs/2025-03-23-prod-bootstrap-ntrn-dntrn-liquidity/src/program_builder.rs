...
pub fn program_builder(params: deployer_lib::ProgramParams) -> ProgramConfig {
    ...
    // Configure the liquidity provider library. It provides liquidity to the pool with tokens from
    // the receive account and sends LP tokens to the Neutron DAO
    ...
    let authorization = AuthorizationBuilder::new()
        ...
        .with_subroutine(double_sided_lp_subroutine)
        .build();
